...
class Test_002_Signin:  # testcase id(Test_001)
    base_url = ReadConfig.getApplicationURL()

    @pytest.mark.sanity
    @pytest.mark.regression
    @testcase_logger("Test_Search_Laptop")
    def test_search_laptop(self, setup):
        self.driver = setup
        self.driver.get(Test_002_Signin.base_url)
        ...
        self.s.search(search_param["search_data2"])
        self.s.select_brand("ASUS")
